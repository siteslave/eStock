...
App.controller('SettingController', function ($scope, SettingService, LxDialogService, LxNotificationService) {
	...
	$scope.doRemoveStaff = function(id) {
		LxNotificationService.confirm('Confirmation', 'Are you sure?', {cancel: 'No', ok: 'Yes'}, function(res) {
			if (res) {
	...
	$scope.doRemoveStock = function(id) {
		...
		LxNotificationService.confirm('Confirmation', 'Are you sure?', {ok: 'Yes', cancel: 'No'}, function(res) {
			if (res) {
